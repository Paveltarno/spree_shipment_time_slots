...
describe Spree::ShipmentTimeSlotSinglePlan do
  ...
  describe ".build_time_slot" do
      ...
      it "should build a valid time slot" do
        ...
        expected_start_time = Time.zone.now.beginning_of_day + subject.starting_hour.hour.hour
        expected_end_time = Time.zone.now.beginning_of_day + subject.ending_hour.hour.hour
